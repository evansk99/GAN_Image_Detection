...
###
#This function shrinks the input images by applying bilinear interpolation
###

def bilinear_resize(image, new_shape):
    return ndimage.zoom(image, (new_shape[0] / image.shape[0], new_shape[1] / image.shape[1], 1), order=1)
...
output_folder = r'F:\IMAGES\bilinear\TRAIN\GRAPHICS'
...
for filename in os.listdir(input_folder):
    if filename.endswith(('.jpg', '.jpeg', '.png')):  # Filter image files
        ...
        image2 = bilinear_resize(image, (new_height, new_width))
